                            ...
                            <div class="pl-lg-4">
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('code') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="code" id="input-code" class="form-control form-control-alternative{{ $errors->has('code') ? ' is-invalid' : '' }}" placeholder="{{ __('Kode Jurusan') }}" value="{{ $department->code, old('code') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('department') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="department" id="input-department" class="form-control form-control-alternative{{ $errors->has('department') ? ' is-invalid' : '' }}" placeholder="{{ __('Jurusan') }}" value="{{ $department->department, old('department') }}" required>
