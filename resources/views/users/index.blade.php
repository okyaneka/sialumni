    ...
    <div class="row">
        <div class="col">
            ...
            <div class="mb-3">
                <form action="{{ route('user.index') }}" class="form-inline" method="GET">
                    <div class="input-group input-group-sm mb-2">
                        <input type="text" name="nama" class="form-control" placeholder="Cari Nama"
                            aria-label="Cari Nama" aria-describedby="search"
                ...
                <div class="modal fade" id="advancedSearch" tabindex="-1" role="dialog" aria-labelledby="advancedSearch"
                    aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <div class="px-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" id="input-code"
                                                class="form-control form-control-alternative" placeholder="Nama"
                                                value="{{ isset($_GET['nama']) ? $_GET['nama'] : ''  }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="jurusan" id="jurusan"
                                                ...
                                                <option
                                                    {{ isset($_GET['jurusan']) && ($_GET['jurusan'] == $department->code) ? 'selected' : '' }}
                                                    value="{{ $department->code }}">{{ $department->department }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="tahun" id="tahun"
                                                ...
                                                @for ($i = DB::table('users')->min('grad'); $i <= DB::table('users')->
                                                    max('grad'); $i++)
                                                    @empty ($i) @else
                                                    <option
